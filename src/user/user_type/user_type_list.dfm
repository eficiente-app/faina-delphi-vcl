inherited UserTypeList: TUserTypeList
  ...
  inherited pnlClientForm: TPanel
    ...
    inherited pnlClientArea: TPanel
      ...
      ExplicitWidth = 583
      ExplicitHeight = 367
      object dbgridUserType: TDBGrid
        Left = 0
        Top = 145
        Width = 583
        Height = 222
        Align = alClient
        DataSource = srcUserType
        ...
        TitleFont.Style = []
        OnCellClick = dbgridUserTypeCellClick
        Columns = <
          item
            Expanded = False
            FieldName = 'id'
  ...
  object srcUserType: TDataSource
    AutoEdit = False
    DataSet = UserTypeController.tblUserType
    Left = 360
    Top = 1
  end

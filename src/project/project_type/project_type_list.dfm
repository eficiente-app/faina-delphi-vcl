inherited ProjectTypeList: TProjectTypeList
  ...
  inherited pnlClientForm: TPanel
    ...
    inherited pnlClientArea: TPanel
      ...
      ExplicitWidth = 583
      ExplicitHeight = 367
      object dbgridProjectType: TDBGrid
        Left = 0
        Top = 145
        Width = 583
        Height = 222
        ...
        TitleFont.Style = []
        OnCellClick = dbgridProjectTypeCellClick
        Columns = <
          item
            Expanded = False
            FieldName = 'id'
  ...
  object srcProjectType: TDataSource
    AutoEdit = False
    DataSet = ProjectTypeController.tblProjectType
    Left = 360
    Top = 1
  end
